...
public class DecalPolygon2 {
	
	public List<Vector3> vertices = new List<Vector3>(9);

	public DecalPolygon2(params Vector3[] vts) {
		vertices.AddRange( vts );
	}

	public static DecalPolygon2 ClipPolygon (DecalPolygon2 polygon, Plane plane) {
		...
		DecalPolygon2 tempPolygon = new DecalPolygon2();
